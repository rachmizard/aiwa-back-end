        ...
        <div class="wrapper-page animated fadeInDown">
            <div class="panel panel-color panel-danger">
                <div class="panel-heading text-center">
                   ...
                   <h3 class="text-center m-t-10"> Reset <strong>Password </strong>Baru</h3>
                </div>

                <form class="form-horizontal m-t-40" method="POST" action="{{ route('admin.password.request') }}">
                        {{ csrf_field() }}
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-xs-12">
                                ...
                                <input id="password" type="password" class="form-control" name="password_confirmation" required placeholder="Password baru konfirmasi">
                    ...
                    <div class="form-group text-right">
                        <div class="col-xs-12">
                            <button class="btn btn-danger w-md" type="submit">Reset <i class="fa fa-check"></i></button>
                        </div>
                    </div>
                </form>
