                          ...
                          <div class="box-layout meta bottom">
                            <div class="col-sm-6 clearfix">
                              ...
                              <div class="media-body">
                                <h3 class="text-white mb-2 m-t-10 ellipsis">{{auth()->guard('admin')->user()->nama_lengkap}}</h3>
                            ...
                            <div class="panel-body p-0"> 
                                ...
                                <div class="tab-content m-0"> 
                                    ...
                                    <div class="profile-desk">
                                        <h1>{{auth()->guard('admin')->user()->nama_lengkap}}</h1>
                                        <span class="designation">{{auth()->guard('admin') ? 'Admin' : ''}}</span>
                                        <!-- <p>
                                    ...
                                    <div class="user-profile-content">
                                        <form role="form">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{auth()->guard('admin')->user()->nama_lengkap}}" id="FullName" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="Email">Email</label>
                                                <input type="email" value="{{auth()->guard('admin')->user()->email}}" id="Email" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="Username">Username</label>
                                                <input type="text" value="{{auth()->guard('admin')->user()->username}}" id="Username" class="form-control">
                                            </div>
                                            <div class="form-group">
