...
<!-- Page Content Start -->
            ...
            <div class="wraper container-fluid">
                ...
                <div class="divider" style="margin-bottom: 10px;">
                    <!-- <a href="/sendtoagen" class="btn btn-info btn-sm">Broadcast ke agen</a> -->
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form role="form" method="POST" action="{{ route('master-broadcast.store') }}">
                                    {{ csrf_field() }}
                                    <div class="form-group">

                                        <label class="control-label" for="anggota_id">Kirim ke agen</label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <select id="anggota_id" multiple name="anggota_id" class="select2" data-placeholder="Agen.." style="width: 100%;">
